...
export const metadata: Metadata = {
  ...
  description: "Building real AI-driven solutions that transform how businesses operate.",
  other: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col items-start justify-center">
                ...
                <p className="text-[#251C6B] text-base">
                  Building real AI-driven solutions that transform how businesses operate.
                </p>
              </div>
              <div className="flex flex-col items-end justify-center">
                <h3 className="text-xl font-bold mb-4 text-[#251C6B]">Connect</h3>
                <p className="text-[#251C6B] text-base text-right">
                  Don't watch the AI wave—ride it. Follow us on{' '}
                  <a 
                    href="https://www.linkedin.com/company/tsunaimi/?viewAsMember=true" 
